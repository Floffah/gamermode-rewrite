...
public class PacketTranslator {
    ...
    public static void execute(int len, int id, ByteArrayDataInput in, SocketConnection conn) throws IOException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
