...
public class NBTUtility {
    public static byte[] toByteArray(NamedTag tag, boolean compressed) throws IOException {
    ...
    public static byte[] toByteArray(Tag<?> tag, boolean compressed) throws IOException {
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
    ...
    public static void toStream(Tag<?> object, OutputStream out, boolean compressed) throws IOException {
        OutputStream output;
        if (compressed) {
